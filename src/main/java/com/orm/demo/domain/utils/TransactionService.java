package com.orm.demo.domain.utils;
...
public class TransactionService {
  ...
  // METODO QUE INICIALIZA EL TIEMPO DE QUE INICIA LA PETICION
  public void startTimeRequest() {
    this.startTime = LocalTime.now();
  }

  // METODO QUE MANDA CREAR EL OBJETO META
  public void setMeta(int codeService, String msjeService) {
    createMeta(codeService, msjeService, null);
  }

  // METODO QUE MANDA CREAR EL OBJETO META CON EXCEPCION
  ...
  // METODO QUE CREA EL OBJETO META
  ...
  // METODO QUE CALCULA EL TIEMPO DE LA PETICION
  ...
  // METODO QUE OBTIENE UN ESTATUS HTPP EN BASE AL CODIGO QUE RETORNARA EL SERVICIO
